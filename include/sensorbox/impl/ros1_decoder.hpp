...
inline constexpr bool ROS1BytesDecoder::is_decodable(const std::string_view msg_type) {
    constexpr auto decodable_msg_types = std::to_array<std::string_view>({"duration", "string", "time",
            ...
            "any_msgs/ExtendedJointState", "anymal_msgs/AnymalState", "anymal_msgs/Contacts",
...
inline constexpr std::string_view ROS1BytesDecoder::starts_with(const std::string_view msg_type) {
    ...
    constexpr auto map = std::to_array<std::pair<std::string_view, std::string_view>>({{"std_msgs/Bool", "bool"},
            ...
            {"sensor_msgs/BatteryState", "std_msgs/Header"}, {"sensor_msgs/CameraInfo", "std_msgs/Header"},
            {"sensor_msgs/ChannelFloat32", "string"}, {"sensor_msgs/CompressedImage", "std_msgs/Header"},
            {"sensor_msgs/FluidPressure", "std_msgs/Header"}, {"sensor_msgs/Illuminance", "std_msgs/Header"},
            {"sensor_msgs/Image", "std_msgs/Header"}, {"sensor_msgs/Imu", "std_msgs/Header"},
            {"sensor_msgs/JointState", "std_msgs/Header"}, {"sensor_msgs/Joy", "std_msgs/Header"},
            {"sensor_msgs/JoyFeedback", "uint8"}, {"sensor_msgs/JoyFeedbackArray", "sensor_msgs/JoyFeedback[]"},
            {"sensor_msgs/LaserEcho", "float32[]"}, {"sensor_msgs/LaserScan", "std_msgs/Header"},
            {"sensor_msgs/MagneticField", "std_msgs/Header"}, {"sensor_msgs/MultiDOFJointState", "std_msgs/Header"},
            {"sensor_msgs/MultiEchoLaserScan", "std_msgs/Header"}, {"sensor_msgs/NavSatFix", "std_msgs/Header"},
            {"sensor_msgs/NavSatStatus", "int8"}, {"sensor_msgs/PointCloud", "std_msgs/Header"},
            {"sensor_msgs/PointCloud2", "std_msgs/Header"}, {"sensor_msgs/PointField", "string"},
            {"sensor_msgs/Range", "std_msgs/Header"}, {"sensor_msgs/RegionOfInterest", "uint32"},
            {"sensor_msgs/RelativeHumidity", "std_msgs/Header"}, {"sensor_msgs/Temperature", "std_msgs/Header"},
            {"sensor_msgs/TimeReference", "std_msgs/Header"}, {"tf2_msgs/TF2Error", "uint8"},
            {"tf2_msgs/TFMessage", "geometry_msgs/TransformStamped[]"}, {"any_msgs/BoolStamped", "std_msgs/Header"},
            {"any_msgs/Event", "time"}, {"any_msgs/ExtendedJointState", "std_msgs/Header"},
            {"any_msgs/Float64Stamped", "std_msgs/Header"}, {"any_msgs/ImuWithTrigger", "sensor_msgs/Imu"},
            {"any_msgs/PointContact", "std_msgs/Header"}, {"any_msgs/SensorTimeInfo", "std_msgs/Header"},
            {"any_msgs/State", "time"}, {"any_msgs/UserInteractionOption", "string"},
            {"anymal_msgs/AnymalState", "std_msgs/Header"}, {"anymal_msgs/BMSState", "uint16[]"},
            {"anymal_msgs/Contact", "std_msgs/Header"}, {"anymal_msgs/Contacts", "anymal_msgs/Contact[]"},
            {"anymal_msgs/GaitPattern", "float64"}, {"anymal_msgs/GaitPatterns", "std_msgs/Header"},
            {"anymal_msgs/LegAttributes", "bool[4]"},
