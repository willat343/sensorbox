...
SENSORBOX_INLINE std::size_t ROS1BytesDecoder::internal_msg_size(const std::string& internal_msg_type,
...
SENSORBOX_INLINE std::size_t ROS1BytesDecoder::internal_vector_msg_size(const std::string& internal_msg_type,
        std::size_t offset) const {
    const std::size_t initial_offset = offset;
