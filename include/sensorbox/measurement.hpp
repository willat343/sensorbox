...
CREATE_SMART_ENUM(MeasurementType, ACTUATOR_MEASUREMENT, ACTUATOR_MEASUREMENTS, ANGULAR_VELOCITY,
        CONTACT_CLASSIFICATIONS, IMU_MEASUREMENT, LINEAR_ACCELERATION, POSE)
