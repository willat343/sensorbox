...
CREATE_SMART_ENUM(MeasurementType, ACTUATOR_MEASUREMENT, ACTUATOR_MEASUREMENTS, ANGLE, ANGULAR_VELOCITY,
        CONTACT_CLASSIFICATIONS, CURRENT, IMU_MEASUREMENT, LINEAR_ACCELERATION, ORIENTATION, POSE, POSE_TWIST, POSITION)
